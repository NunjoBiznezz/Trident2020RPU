...
constexpr uint8_t LAMP_BONUS_1 = 0;
constexpr uint8_t LAMP_BONUS_2 = 1;
constexpr uint8_t LAMP_BONUS_3 = 2;
constexpr uint8_t LAMP_BONUS_4 = 3;
constexpr uint8_t LAMP_BONUS_5 = 4;
constexpr uint8_t LAMP_BONUS_6 = 5;
constexpr uint8_t LAMP_BONUS_7 = 6;
constexpr uint8_t LAMP_BONUS_8 = 7;
constexpr uint8_t LAMP_BONUS_9 = 8;
constexpr uint8_t LAMP_BONUS_10 = 9;
constexpr uint8_t LAMP_DROP_TARGET_5 = 10;
constexpr uint8_t LAMP_STAND_UP_SPECIAL = 11;
constexpr uint8_t LAMP_LEFT_SPINNER_AMBER = 12;
constexpr uint8_t LAMP_LEFT_SPINNER_WHITE = 13;
constexpr uint8_t LAMP_STAND_UP_AMBER = 14;
constexpr uint8_t LAMP_STAND_UP_WHITE = 15;
constexpr uint8_t LAMP_RIGHT_SPINNER_YELLOW = 16;
constexpr uint8_t LAMP_RIGHT_SPINNER_GREEN = 17;
constexpr uint8_t LAMP_STAND_UP_YELLOW = 18;
constexpr uint8_t LAMP_STAND_UP_GREEN = 19;
constexpr uint8_t LAMP_DROP_TARGET_4 = 20;
constexpr uint8_t LAMP_DROP_TARGET_3 = 21;
constexpr uint8_t LAMP_DROP_TARGET_2 = 22;
constexpr uint8_t LAMP_DROP_TARGET_1 = 23;
constexpr uint8_t LAMP_TOP_EJECT_30K = 24;
constexpr uint8_t LAMP_TOP_EJECT_20K = 25;
constexpr uint8_t LAMP_TOP_EJECT_10K = 26;
constexpr uint8_t LAMP_TOP_EJECT_5K = 27;
constexpr uint8_t LAMP_BONUS_5X_FEATURE = 28;
constexpr uint8_t LAMP_BONUS_4X_FEATURE = 29;
constexpr uint8_t LAMP_BONUS_3X_FEATURE = 30;
constexpr uint8_t LAMP_BONUS_2X_FEATURE = 31;
constexpr uint8_t LAMP_BONUS_5X = 32;
constexpr uint8_t LAMP_BONUS_4X = 33;
constexpr uint8_t LAMP_BONUS_3X = 34;
constexpr uint8_t LAMP_BONUS_2X = 35;
constexpr uint8_t LAMP_LEFT_LANE_8K = 36;
constexpr uint8_t LAMP_LEFT_LANE_6K = 37;
constexpr uint8_t LAMP_LEFT_LANE_4K = 38;
constexpr uint8_t LAMP_LEFT_LANE_2K = 39;
constexpr uint8_t LAMP_SHOOT_AGAIN = 40;
constexpr uint8_t LAMP_MATCH = 41;
constexpr uint8_t LAMP_STAND_UP_PURPLE = 42;
constexpr uint8_t LAMP_DROP_TARGET_SPECIAL = 43;
constexpr uint8_t LAMP_RIGHT_SPINNER_PURPLE = 44;
constexpr uint8_t LAMP_RIGHT_OUTLANE_SPECIAL = 45;
constexpr uint8_t LAMP_LEFT_SPINNER_PURPLE = 46;
constexpr uint8_t LAMP_EXTRA_BALL = 47;
constexpr uint8_t LAMP_BALL_IN_PLAY = 48;
constexpr uint8_t LAMP_HIGH_SCORE_TO_DATE = 49;
constexpr uint8_t LAMP_GAME_OVER = 50;
constexpr uint8_t LAMP_TILT = 51;
constexpr uint8_t LAMP_PLAYER_1 = 52;
constexpr uint8_t LAMP_PLAYER_2 = 53;
constexpr uint8_t LAMP_PLAYER_3 = 54;
constexpr uint8_t LAMP_PLAYER_4 = 55;
constexpr uint8_t LAMP_PLAYER_1_UP = 56;
constexpr uint8_t LAMP_PLAYER_2_UP = 57;
